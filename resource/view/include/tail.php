			...
			<footer class="footer" id="footer">
							...
							<div class="col-lg-4 col-md-6">
								<div class="widget">
									<ul class="contact-info">
										<li><span class="contact-info-label">Address:</span>Sousse, Sahloul-3001,Tunis</li>
										<li><span class="contact-info-label">Phone:</span>call Free <a href="tel:">(+216) 73 678 899</a></li>
										<li><span class="contact-info-label">Email:</span> <a href="azizjenhani11@gmail.com">azizjenhani11@gmail.com</a></li>
									</ul>
								</div>
							</div>
						</div>
				...
				<div class="container">
					<div class="footer-bottom">
						<p class="footer-copyright mt-1">All Rights Reserved &copy; <?= date('Y') ?> | 
						</p>
