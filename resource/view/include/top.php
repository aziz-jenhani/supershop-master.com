			...
			<div class="header-top">
				<div class="container">
					<div class="header-left header-dropdowns">
						...
						<div class="header-dropdown">
							<a href="#"><img src="public/assets/images/favicon/en.png" alt="England flag">ENGLISH</a>
							<div class="header-menu">
								<ul>
				...
				<div class="container">
					...
					<div class="header-right">
						...
						<div class="header-contact"><span>Call us now</span>
							<a href="tel:#"><strong>+216 73 678 899</strong></a>
						</div>
							...
							<div class="dropdown-menu">
								<div class="dropdownmenu-wrapper">
											...
											echo '
													<div class="product">
														<div class="product-details">
															...
															<span class="cart-product-qty">' . $eachCartItem['quantity'] . '</span> X ' . "$" . ' ' . $eachCartItem['product_price'] . '</span>
														</div>
									...
									<div class="dropdown-cart-total">
										<span>Sub Total</span>
										<span class="cart-total-price"><?php echo "$" . " " . $subTotal; ?></span>
									</div>
