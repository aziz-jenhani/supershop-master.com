							...
							<div class="product-single-details">
								...
								<div class="price-box">
									<span class="product-price">
										...
										<?php
											#== PRODUCT PRICE
											echo "$" . " " . $productResult[0]['product_price'];
										?>
								...
								?>
										...
										<div class="product product-sm">
											...
											<div class="product-details">
												...
												<div class="price-box">
													<span class="product-price"><?= "$" . " " . $eachFeatured['product_price'] ?></span>
												</div>
											</div>
										</div>
						...
						foreach($relevantResult AS $eachrelevantProduct)
						{
							...
							<div class="product">
								...
								<div class="product-details">
									...
									<div class="price-box">
										<span class="product-price">'. "$" . " " . $eachrelevantProduct['product_price'] .'</span>
									</div>
