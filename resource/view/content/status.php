							...
							<div class="row">
								<div class="col-md-12 inv-label">
									...
									<h2 style="font-size: 40px; font-weight: bold">
										<?= "$" . " " . @$getdetailsResult[0]['grand_total']; ?>
									</h2>
								</div>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-4 col-xs-5 invoice-block pull-right">
							<ul class="unstyled amounts">
								<li>Sub-Total amount :
									<?= "$" . " " . $getdetailsResult[0]['sub_total']; ?>
								</li>
								<li>Discount :
									<?= "$" . " " . $getdetailsResult[0]['discount_amount']; ?>
								</li>
								<li>TAX 
									<?= "$" . " " . $getdetailsResult[0]['tax']; ?>
								</li>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-md-4 col-xs-5 invoice-block pull-right">
								<ul class="unstyled amounts">
									<li>Sub - Total amount : <?= "$" . " " . $getdetailsResult[0]['sub_total'] ;?></li>
									<?php 
										#== IF CUSTOMER GET DISCOUNT
										if(@$getdetailsResult[0]['discount_amount'] > 0)
										{
											echo '<li>Discount : ' . "$" . " " . $getdetailsResult[0]['discount_amount'] . '</li>';				
										}
									?>
									<li>Discount :
										<?= "$" . " " . $getdetailsResult[0]['discount_amount']; ?>
									...
									<li>TAX 
										<?php echo '(' . $GLOBALS['TAX'] . '%) :' . " " . "$" . " " . $getdetailsResult[0]['tax']; ?>
									</li>
									<li class="grand-total">Grand Total : 
										<?php echo "$" . " " . $getdetailsResult[0]['grand_total']; ?>
									</li>
								</ul>
							</div>
						</div>
