	...
	<div class="container">
		<div class="map">
			...
			<script type="text/javascript">
				...
				var marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(35.8124921,10.6361194)});infowindow = new google.maps.InfoWindow({content:"<b>https://issatso.rnu.tn/</b><br/>BSCIC-1420<br/> Narayanganj" });google.maps.event.addListener(marker, "click", function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);
			</script> 
			...
			<div class="col-md-4">
				...
				<div class="contact-info">
					<div>
						...
						<p><a href="tel:">+216 73 672 899</a></p>
						<p>Cell Number</p>
					</div>
					<div>
						<i class="icon-mobile"></i>
						<p><a href="tel:">+216 92 670 799</a></p>
						<p>Home Number</p>
					</div>
					<div>
						<i class="icon-mail-alt"></i>
						<p><a href="mailto:#">aziz@admin.com</a></p>
						<p><a href="mailto:#">aziz@admin.com</a></p>
					</div>
					<div>
						<i class="icon-skype"></i>
						<p><a href="">Aziz</a></p>
						<p>Software Engennering</p>
					</div>
				</div>
			</div>
		</div>
